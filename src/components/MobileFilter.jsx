...
const MobileFilter = ({openFilter, setOpenFilter, search, setSearch, brand, setBrand, priceRange, setPriceRange, category, setCategory, handleBrandChange, handleCategoryChange}) => {
    ...
    </div>
    {
        openFilter ? <div className="bg-gray-100 p-2 md:hidden">
            ...
            className='bg-white p-2rounded-md border-gray-400 border-2 w-full' />

            {/*category only data */}
            <h1 className="mt-5 font-semibold tex-xl">Category</h1>
            ...
            {/* brand only data */}
            <h1 className="mt-5 font-semibold tex-xl mb-3">Brand</h1>
            <select name='' id="" className='bg-white w-full p-2 border-gray-200 border-2 rounded-mp ' 
            value={brand}
